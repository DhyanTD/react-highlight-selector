...
var DefaultPopover = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            ...
            gap: '5px',
                    ...
                    alignItems: 'center',
                }, children: [disableMultiColorHighlight ? null : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { onClick: function () { return changeColor('bg-red'); }, style: {
                            ...
                            fontSize: 24,
                            fontWeight: 'bold',
                        }, children: [' ', "\uD83D\uDDD1"] }), handleCopy && ((0, jsx_runtime_1.jsxs)("div", { onClick: function (e) { e.stopPropagation(); handleCopy(selection); }, style: { color: 'black', cursor: 'pointer', fontSize: 16 }, children: [' ', "copy"] }))] })] }));
};
